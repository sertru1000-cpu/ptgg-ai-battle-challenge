...
import src.agents.dragapult_policy_v19 as _v6  # V25: leader decklist + V19 policy as DECK/fallback source  # noqa: E402 -- DECK + pure-Python fallback agent
from src.agents.dragapult_agent_v25_cpp import opponent_model  # noqa: E402 -- Block A1
...
def _native_lib_filename() -> str:
    ...
    if system == "Windows":
        return "v25_mcts.dll"
    if system == "Darwin":
        return "libv25_mcts.dylib"
    return "libv25_mcts.so"
