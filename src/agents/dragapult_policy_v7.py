"""V7 -- V6 engine with the residual Phantom Dive Bench-target planner bug
fixed (V6 itself is NOT modified by this file -- see
src/agents/dragapult_policy_v6.py, still the live Kaggle submission).
