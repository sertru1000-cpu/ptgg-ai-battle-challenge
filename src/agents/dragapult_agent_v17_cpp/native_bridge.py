"""Native C++ MCTS bridge for V17. See README.md for the full architecture
...
DECK = _v6.DECK  # V17 plays V6's exact decklist (governing task Objective 1)
...
def _native_lib_filename() -> str:
    ...
    if system == "Windows":
        return "v17_mcts.dll"
    if system == "Darwin":
        return "libv17_mcts.dylib"
    return "libv17_mcts.so"
