"""Native C++ MCTS bridge for V18 (V17 + Block A1: opponent-archetype-
conditioned determinization with discard accounting -- see opponent_model.py
and V17_ROADMAP.md). See README.md for the full architecture
...
from src.agents.dragapult_agent_v18_cpp import opponent_model  # noqa: E402 -- Block A1
...
V17_MAX_LOOKING = 20
V17_MAX_OPP_POOL = 60
V17_ABI_MAGIC = 0x56313841  # "V18A" -- bumped for the oppHiddenPool fields (Block A1)
...
def _native_lib_filename() -> str:
    ...
    if system == "Windows":
        return "v18_mcts.dll"
    if system == "Darwin":
        return "libv18_mcts.dylib"
    return "libv18_mcts.so"
